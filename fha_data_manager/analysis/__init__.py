...
from .exploratory import (
    ...
    plot_interest_rate_and_loan_amount_by_product_type,
    plot_interest_rate_and_loan_amount_by_property_type,
    plot_interest_rate_and_loan_amount_by_loan_purpose,
